namespace unlockfps_nc
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent ( )
        {
            ...
            TabDlls = new TabPage ( );
            CBMigoto = new CheckBox ( );
            CBFallback = new CheckBox ( );
            ...
            TabCtrlSettings.Size = new Size ( 285, 222 );
            ...
            TabGeneral.Size = new Size ( 277, 194 );
            ...
            TabLaunchOptions.Size = new Size ( 277, 194 );
            ...
            // TabDlls
            // 
            TabDlls.Controls.Add ( CBMigoto );
            TabDlls.Controls.Add ( CBFallback );
            ...
            TabDlls.RightToLeft = RightToLeft.No;
            TabDlls.Size = new Size ( 277, 194 );
            TabDlls.TabIndex = 2;
            TabDlls.Text = "DLLs";
            ...
            // CBMigoto
            // 
            CBMigoto.AutoSize = true;
            CBMigoto.Location = new Point ( 138, 104 );
            CBMigoto.Name = "CBMigoto";
            CBMigoto.Size = new Size ( 101, 19 );
            CBMigoto.TabIndex = 5;
            CBMigoto.Text = "Use 3DMigoto";
            ToolTipSettings.SetToolTip ( CBMigoto, "Disabled feature for now because it constantly resets. You can safely remove 3dmigoto entirely if needed" );
            CBMigoto.UseVisualStyleBackColor = true;
            // 
            // CBFallback
            // 
            CBFallback.AutoSize = true;
            CBFallback.Location = new Point ( 138, 129 );
            CBFallback.Name = "CBFallback";
            CBFallback.Size = new Size ( 133, 19 );
            CBFallback.TabIndex = 5;
            CBFallback.Text = "Use Gshade Fallback";
            ToolTipSettings.SetToolTip ( CBFallback, "Resolves imgui crashes and brings a few useful features and compatibility with presets at the cost of reverting to reshade 5.8" );
